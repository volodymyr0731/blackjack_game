...
#chat-container -> top (0), right (0)
#chat-button -> top (0), right (0)
...
function setUpTable () {
  ...
  let $credits = $('<div>', {'id': 'credits', 'class': 'info-content'}).html('<p>©2017 Ryan Edwards</p><p>Sounds from <a href="https://www.zapsplat.com">zapsplat.com</a> and <a href="http://kenney.nl/">kenney.nl</a></p>');
  let $description = $('<div>', {'id': 'description', 'class':'info-content'}).html("<h2>What is Blackjack?</h2><br/><p>In Blackjack, players face off against the dealer. The dealer and the players each initially get two cards. The players can only see one of the dealer's cards. The cards are worth face value, except Aces and face cards (J, Q, K), which are 1 or 11 and 10, respectively.</p><br/>"
