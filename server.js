...
// const options = {
//  key: fs.readFileSync('C:/Users/nshid/OneDrive/Documents/Business/BlackJack Multiplayer/private.ppk'),
//  cert: fs.readFileSync('C:/Users/nshid/OneDrive/Documents/Business/BlackJack Multiplayer/public.cert'),
//  //requestCert: false,
...
io.on('connection', function(socket) {
  ...
  socket.on('new user', function(data) {
    ...
    console.log(users);
    if (players.length < 6 && !gameInProgress) {
